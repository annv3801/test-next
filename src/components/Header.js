...
export default function Header({configData}) {
    ...
    return (
        <header ref={node} className='bg-white font-[sans-serif] sticky top-0 z-50'>
            {
                isOverlayVisible &&
            ...
            <div className="h-[96px]">
                <div className='flex lg:justify-between relative py-3 sm:px-10 px-4 border-gray-200 container mx-auto my-auto h-full'>
                    ...
                    <div className='bg-white flex flex-col rounded-3xl max-lg:hidden relative z-20 my-auto'>
