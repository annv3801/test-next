            ...
            <div className="container mx-auto py-6 md:py-10 px-4 md:px-0 custom-font">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <div className="bg-[#e9e9e9] rounded-lg p-5">
                        ...
                        <div className="flex mb-3">
                            <a href="/bao-mat-thong-tin" className="capitalize text-sm md:text-base my-auto">Bảo mật thông tin</a>
                        </div>
                        <div className="flex mb-3">
                            <a href="/giao-hang-doi-tra" className="capitalize text-sm md:text-base my-auto">Giao hàng & đổi trả</a>
                        </div>
                    </div>
                    <div className="bg-[#e9e9e9] rounded-lg p-5">
                        ...
                        <div className="flex mb-3">
                            <a href="/san-pham-moi" className="capitalize text-sm md:text-base my-auto">Sản Phẩm Mới</a>
                        </div>
                    </div>
                    <div className="bg-[#e9e9e9] rounded-lg p-5">
                        ...
                        <div className="flex gap-2 md:gap-5 mb-3">
                            ...
                            <div className="text-sm md:text-lg my-auto">Hà Nội</div>
                        </div>
                        <div className="flex gap-2 md:gap-5 mb-3">
                            ...
                            <div className="flex gap-1">
                                <div className="text-sm md:text-lg my-auto">Hotline - Zalo:</div>
                                <a href={`tel:${configData?.phoneNumber}`} className="hover:text-blue-500 text-sm md:text-lg my-auto">{configData?.phoneNumber?.replace(/(\d{3})(\d{3})(\d{4})/, "$1.$2.$3")}</a>
                            </div>
                        </div>
                        <div className="flex gap-2 md:gap-5 mb-3">
                            ...
                            <div className="flex gap-1">
                                <div className="text-sm md:text-lg my-auto">Facebook:</div>
                                <a href={`${configData?.urlFacebook}`} target="_blank" className="hover:text-blue-500 text-sm md:text-lg my-auto">Rượu Duty Sân Bay Các Nước</a>
                            </div>
                        </div>
                        <div className="flex gap-2 md:gap-5 mb-3">
                            ...
                            <div className="flex gap-1">
                                <div className="text-sm md:text-lg my-auto">Messenger:</div>
                                <a href={`//${configData?.messenger}`} target="_blank" className="hover:text-blue-500 text-sm md:text-lg my-auto">Rượu Duty Sân Bay Các Nước</a>
                            </div>
                        </div>
                        <div className="flex gap-2 md:gap-5 mb-3">
                            ...
                            <div className="flex gap-1">
                                <div className="text-sm md:text-lg my-auto">Email:</div>
                                <a href={`mailto:${configData?.email}`} target="_blank" className="hover:text-blue-500 text-sm md:text-lg my-auto">{configData?.email}</a>
                            </div>
                        </div>
                    </div>
                </div>
