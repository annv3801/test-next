            ...
            <div className="container mx-auto py-6 md:py-10 px-4 md:px-0 custom-font">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <div className="bg-[#e9e9e9] rounded-lg p-5">
                        <h4 className="capitalize text-lg font-bold mb-1">Về chúng tôi</h4>
                    ...
                    <div className="bg-[#e9e9e9] rounded-lg p-5">
                        <h4 className="capitalize text-lg font-bold mb-1">Thông tin</h4>
                        <div className="flex mb-3">
                    ...
                    <div className="bg-[#e9e9e9] rounded-lg p-5">
                        <h4 className="capitalize text-lg font-bold mb-1">Thông Tin Liên hệ</h4>
